...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__downloads__ = __webpack_require__(42);
...
var registerCoreBlocks = function registerCoreBlocks() {
	[__WEBPACK_IMPORTED_MODULE_0__downloads__].forEach(function (_ref) {
		var name = _ref.name,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__edit__ = __webpack_require__(43);
/**
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_querystringify__ = __webpack_require__(91);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__editor_scss__ = __webpack_require__(88);
...
var DownloadsEdit = function (_Component) {
	__WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_inherits___default()(DownloadsEdit, _Component);

	function DownloadsEdit(props) {
		__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck___default()(this, DownloadsEdit);

		var _this = __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_possibleConstructorReturn___default()(this, (DownloadsEdit.__proto__ || __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_get_prototype_of___default()(DownloadsEdit)).apply(this, arguments));
	...
	__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(DownloadsEdit, [{
		...
		value: function fetchDownloadCategories() {
			...
			var request = apiFetch({
				path: '/wp/v2/download_category?' + Object(__WEBPACK_IMPORTED_MODULE_5_querystringify__["stringify"])({
					per_page: -1
				})
			});
...
/* harmony default export */ __webpack_exports__["a"] = (DownloadsEdit);
