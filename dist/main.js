...
/***/ "./includes/blocks/downloads/components/DownloadTag.js":
/*!*************************************************************!*\
  !*** ./includes/blocks/downloads/components/DownloadTag.js ***!
  \*************************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _Title__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Title */ \"./includes/blocks/downloads/components/Title.js\");\n/* harmony import */ var _Description__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Description */ \"./includes/blocks/downloads/components/Description.js\");\n\n\n\nvar DownloadTag = function DownloadTag(props) {\n\tvar _props$attributes = props.attributes,\n\t    showTitle = _props$attributes.showTitle,\n\t    showCount = _props$attributes.showCount,\n\t    showDescription = _props$attributes.showDescription;\n\tvar _props$tag = props.tag,\n\t    name = _props$tag.name,\n\t    link = _props$tag.link,\n\t    count = _props$tag.count,\n\t    description = _props$tag.description;\n\n\n\treturn wp.element.createElement(\n\t\t'div',\n\t\t{ className: 'edd-download-tag' },\n\t\tshowTitle && wp.element.createElement(_Title__WEBPACK_IMPORTED_MODULE_0__[\"default\"], {\n\t\t\ttitle: name,\n\t\t\tlink: link,\n\t\t\tclassName: 'edd_download_title',\n\t\t\tshowCount: showCount,\n\t\t\tcount: count,\n\t\t\ttype: 'download-tag'\n\t\t}),\n\t\tshowDescription && wp.element.createElement(_Description__WEBPACK_IMPORTED_MODULE_1__[\"default\"], {\n\t\t\tdescription: description,\n\t\t\tshowDescription: showDescription,\n\t\t\tclassName: 'edd-download-tag-description'\n\t\t})\n\t);\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (DownloadTag);\n\n//# sourceURL=webpack:///./includes/blocks/downloads/components/DownloadTag.js?");
